 ...
 */
?>
<div data-href="<?php echo Yii::app()->createUrl('/message/message/view', ['mid' => $data->id]); ?>" data-action="data-href" class="<?php echo ($data->getIsNew() ? 'message-preview-noread ' : ''); ?>clearfix dialogue-item">
    <a href="#remove" class="dialogue-remove"><i class="fa fa-times"></i></a>
    <table>
        <tr>
            <td>
            ...
            <td class="dialogue-info">
                <div>
                    <?php echo CHtml::link($data->recipient->nick_name, ['/user/people/userInfo', 'username' => $data->recipient->nick_name]); ?>
                </div>
                <div class="dialogue-info-time"><time class="timeago" datetime="<?php echo $data->sent_at; ?>"><?php echo $data->sent_at; ?></time></div>
            </td>
            <td>
